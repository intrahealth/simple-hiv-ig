...
curl $FHIR'/Measure/DASHTXCURR/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
curl $FHIR'/Measure/DASHTXML/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
curl $FHIR'/Measure/DASHTXNEW/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
curl $FHIR'/Measure/DASHTXPVLS/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
curl $FHIR'/Measure/DASHHTSTST/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
