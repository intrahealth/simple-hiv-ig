...
cd bulk
./bulk-process.py female.template.fsh ru 30
./bulk-process.py male.template.fsh fr 30
cd ..
...
curl $FHIR'/Measure/TXPVLS/$evaluate-measure?periodStart=2000&periodEnd=2021' | jq . 
