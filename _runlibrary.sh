...
curl https://cds-sandbox.alphora.com/cqf-ruler-r4/fhir/Patient/1520

curl https://cds-sandbox.alphora.com/cqf-ruler-r4/fhir/Library/DataContract/$evaluate?subject=Patient/1520
